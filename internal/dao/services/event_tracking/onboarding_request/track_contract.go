...
func (s *TrackContract) Execute() error {
	...
	case onboarding_request.VotingEndedEventName:
	...
	case onboarding_request.VotingCanceledEventName:
	...
	case onboarding_request.BallotCastEventName:
	...
	case onboarding_request.BallotCanceledEventName:
